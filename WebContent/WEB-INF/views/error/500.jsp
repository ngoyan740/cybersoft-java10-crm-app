...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href='<c:url value="/assets/bootstrap/dist/css/bootstrap.min.css"></c:url>' rel="stylesheet">
    <!-- animation CSS -->
    ...
    <!-- color CSS -->
    <link href='<c:url value="/assets/css/colors/blue.css"></c:url>' id="theme" rel="stylesheet">
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>500</h1>
                <h3 class="text-uppercase">VUI LÒNG QUAY LẠI SAU!</h3>
